	...
	<div class="hdp-body" id="hdp-body">
		<form class="form-horizontal">
		  <div class="form-group">
		    <label for="hdp-lirun" class="col-sm-2 control-label">总利润</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-lirun" value="0.00" readonly="readonly">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-xiaoshou" class="col-sm-2 control-label">总销售</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-xiaoshou" value="${xiaoshou}" readonly="readonly">
		    </div>
		  </div>
		</form>
	</div>
