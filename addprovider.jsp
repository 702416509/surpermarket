...
<html lang="zh-CN">
  ...
  <c:if test="${sessionScope.user eq null}"><c:redirect url="login.jsp"/></c:if>
	...
	<div class="hdp-body" id="hdp-body">
		<form class="form-horizontal" method="post" action="dataaddServlet?action=addprovidernow">
		  <div class="form-group">
		    <label for="hdp-GPName" class="col-sm-2 control-label">供货商名称</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-GPName" placeholder="供货商名称">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-GPPhone" class="col-sm-2 control-label">电话</label>
		    <div class="col-sm-10">
		      <input type="tel" class="form-control" name="hdp-GPPhone" placeholder="电话">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-GPAddress" class="col-sm-2 control-label">地址</label>
		    <div class="col-sm-10">
				<input type="text" class="form-control" name="hdp-GPAddress" placeholder="地址">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-GPLinkman" class="col-sm-2 control-label">联系人</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-GPLinkman" placeholder="联系人">
		    </div>
		  </div>
		  <div class="form-group">
