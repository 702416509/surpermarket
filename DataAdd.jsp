...
<html lang="zh-CN">
  ...
  <c:if test="${sessionScope.user eq null}"><c:redirect url="login.jsp"/></c:if>
	...
	<div class="hdp-body" id="hdp-body">
		<form class="form-horizontal" method="post" action="dataaddServlet?action=addnow">
		  <div class="form-group">
		    <label for="hdp-GId" class="col-sm-2 control-label">商品条码</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-GId" placeholder="商品条码">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-GName" class="col-sm-2 control-label">商品名称</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-GName" placeholder="商品名称">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-CId" class="col-sm-2 control-label">种类</label>
		    <div class="col-sm-10">
				<select class="form-control" name="hdp-CId">
		    		<c:forEach var="goodsclasslist" items="${goodsclasslist}">
						<option value="${goodsclasslist.CId }">${goodsclasslist.CName }</option>
					</c:forEach>
				</select>
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-GSpec" class="col-sm-2 control-label">规格等级</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-GSpec" placeholder="规格等级">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-GUId" class="col-sm-2 control-label">单位</label>
		    <div class="col-sm-10">
		    	<select class="form-control" name="hdp-GUId">
		    		<c:forEach var="goodsunitlist" items="${goodsunitlist}">
						<option value="${ goodsunitlist.GUId}">${goodsunitlist.GUName }</option>
					</c:forEach>
				</select>
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-GMinNumber" class="col-sm-2 control-label">报警数量</label>
		    <div class="col-sm-10">
		      <input type="number" class="form-control" name="hdp-GMinNumber" placeholder="报警数量">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-SalePrice" class="col-sm-2 control-label">零售价</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-SalePrice" id="hdp-SalePrice" placeholder="零售价">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-VipPrice" class="col-sm-2 control-label">会员价</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-VipPrice" id="hdp-VipPrice" placeholder="会员价">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-GAmount" class="col-sm-2 control-label">库存数量</label>
		    <div class="col-sm-10">
		      <input type="number" class="form-control" name="hdp-GAmount" placeholder="库存数量">
		    </div>
		  </div>
		  <div class="form-group">
