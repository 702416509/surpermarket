  ...
  <c:if test="${sessionScope.user eq null}"><c:redirect url="login.jsp"/></c:if>
	...
	<div class="hdp-body" id="hdp-body">
		  <div class="form-group">
		    <label for="hdp-update-UPassword" class="col-sm-2 control-label">修改密码</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-update-UPassword" id="hdp-update-UPassword" placeholder="修改密码"><div id="upadtepwdtip">未输入</div>
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-update-reUPassword" class="col-sm-2 control-label">确认修改密码</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-update-reUPassword" id="hdp-update-reUPassword" placeholder="确认修改密码"><div id="reupdatepwdtip">未输入</div>
		    </div>
		  </div>
		  <div class="form-group">
		    <div class="col-sm-offset-2 col-sm-10">
		      <button type="submit" class="btn btn-success" id="updatepwd-btn">修改</button>
		    </div>
		  </div>
	</div>
