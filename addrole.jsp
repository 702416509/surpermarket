...
<html lang="zh-CN">
  ...
  <c:if test="${sessionScope.user eq null}"><c:redirect url="login.jsp"/></c:if>
	...
	<div class="hdp-body" id="hdp-body">
		<form class="form-horizontal" method="post" action="dataaddServlet?action=addrolenow">
		  <div class="form-group">
		    <label for="hdp-RName" class="col-sm-2 control-label">角色名</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-RName" placeholder="角色名">
		    </div>
		  </div>
		  <div class="form-group">
