...
<html lang="zh-CN">
  ...
  <c:if test="${sessionScope.user eq null}"><c:redirect url="login.jsp"/></c:if>
	...
	<div class="hdp-body" id="hdp-body">
		<form class="form-horizontal" method="post" action="dataaddServlet?action=addshopvipnow">
		  <div class="form-group">
		    <label for="hdp-VId" class="col-sm-2 control-label">会员卡号</label>
		    <div class="col-sm-10">
		    	<% 
		    		Date date = new Date();
		    		DateFormat dateFormat = new SimpleDateFormat("YYYYMMddHHmmss");
		    		String VId = dateFormat.format(date);
		    	 %>
		    	<input type="text" class="form-control" name="hdp-VId" value="<%=VId %>" readonly="readonly">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-VName" class="col-sm-2 control-label">姓名</label>
		    <div class="col-sm-10">
		    	<input type="text" class="form-control" name="hdp-VName" placeholder="姓名">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-VPhone" class="col-sm-2 control-label">电话</label>
		    <div class="col-sm-10">
				<input type="number" class="form-control" name="hdp-VPhone" placeholder="电话">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-ConsumeSum" class="col-sm-2 control-label">消费总金额</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-ConsumeSum" placeholder="消费总金额">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-ConsumeScore" class="col-sm-2 control-label">积分</label>
		    <div class="col-sm-10">
		    	<input type="text" class="form-control" name="hdp-ConsumeScore" placeholder="积分">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-ConsumeCount" class="col-sm-2 control-label">消费次数</label>
		    <div class="col-sm-10">
		    	<input type="number" class="form-control" name="hdp-ConsumeCount" placeholder="消费次数">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-ConsumeRate" class="col-sm-2 control-label">积分率</label>
		    <div class="col-sm-10">
		    	<input type="text" class="form-control" name="hdp-ConsumeRate" placeholder="积分率">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-VBirthday" class="col-sm-2 control-label">生日</label>
		    <div class="col-sm-10">
		    	<input type="date" class="form-control" name="hdp-VBirthday" placeholder="生日">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-VBalance" class="col-sm-2 control-label">余额</label>
		    <div class="col-sm-10">
		    	<input type="text" class="form-control" name="hdp-VBalance" placeholder="余额">
		    </div>
		  </div>
		  <div class="form-group">
