...
<html lang="zh-CN">
  ...
  <c:if test="${sessionScope.user eq null}"><c:redirect url="login.jsp"/></c:if>
	...
	<div class="hdp-body" id="hdp-body">
		<form class="form-horizontal" method="post" action="dataaddServlet?action=addusernow">
		  <div class="form-group">
		    <label for="hdp-UId" class="col-sm-2 control-label">账号</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-UId" placeholder="账号">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-UPassword" class="col-sm-2 control-label">密码</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-UPassword" placeholder="进货时间">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-UName" class="col-sm-2 control-label">真实姓名</label>
		    <div class="col-sm-10">
				<input type="text" class="form-control" name="hdp-UName" placeholder="真实姓名">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="hdp-RId" class="col-sm-2 control-label">角色</label>
		    <div class="col-sm-10">
		      <select class="form-control" name="hdp-RId">
		    		<c:forEach var="rolelist" items="${rolelist}">
						<option value="${rolelist.RId }">${rolelist.RName }</option>
					</c:forEach>
				</select>
		    </div>
		  </div>
