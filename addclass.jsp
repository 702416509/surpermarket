...
<html lang="zh-CN">
  ...
  <c:if test="${sessionScope.user eq null}"><c:redirect url="login.jsp"/></c:if>
	...
	<div class="hdp-body" id="hdp-body">
		<form class="form-horizontal" method="post" action="dataaddServlet?action=addgoodsclassnow">
		  <div class="form-group">
		    <label for="hdp-CName" class="col-sm-2 control-label">类别名称</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="hdp-CName" placeholder="类别名称">
		    </div>
		  </div>
		  <div class="form-group">
